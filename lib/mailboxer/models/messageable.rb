module Mailboxer
  module Models
    module Messageable
      ...
      def reply_to_conversation(conversation, reply_body, subject=nil, should_untrash=true, sanitize_text=true, attachment=nil, should_undelete = false)
        ...
        if should_undelete && mailbox.is_deleted?(conversation)
